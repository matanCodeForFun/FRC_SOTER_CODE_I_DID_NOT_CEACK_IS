 ...
 *
 * <p>The angle is continuous, that is if a NzRotation2d is constructed with 361 degrees, it will
...
public class Rotation2d
  ...
  /**
   * A preallocated NzRotation2d representing no rotation.
   *
  ...
  /**
   * A preallocated NzRotation2d representing a clockwise rotation by π/2 rad (90°).
   *
   * <p>This exists to avoid allocations for common rotations.
   */
  ...
  /**
   * A preallocated NzRotation2d representing a clockwise rotation by 90° (π/2 rad).
   *
   * <p>This exists to avoid allocations for common rotations.
   */
  ...
  /**
   * A preallocated NzRotation2d representing a counterclockwise rotation by π/2 rad (90°).
   *
   * <p>This exists to avoid allocations for common rotations.
   */
  ...
  /**
   * A preallocated NzRotation2d representing a counterclockwise rotation by 90° (π/2 rad).
   *
   * <p>This exists to avoid allocations for common rotations.
   */
  ...
  /**
   * A preallocated NzRotation2d representing a counterclockwise rotation by π rad (180°).
   *
   * <p>This exists to avoid allocations for common rotations.
   */
  ...
  /**
   * A preallocated NzRotation2d representing a counterclockwise rotation by 180° (π rad).
   *
   * <p>This exists to avoid allocations for common rotations.
   */
  ...
  /** Constructs a NzRotation2d with a default angle of 0 degrees. */
  public Rotation2d() {
    m_value = 0.0;
    m_cos = 1.0;
    m_sin = 0.0;
  ...
  /**
   * Constructs a NzRotation2d with the given radian value.
   *
  ...
  public Rotation2d setValue(double value) {
    this.m_value = value;
  ...
  /**
   * Constructs a NzRotation2d with the given x and y (cosine and sine) components.
   *
  ...
  public Rotation2d(double x, double y) {
    ...
    if (magnitude > 1e-6) {
      ...
      MathSharedStore.reportError(
          "x and y components of NzRotation2d are zero\n", Thread.currentThread().getStackTrace());
    }
    m_value = Math.atan2(m_sin, m_cos);
  }

  public Rotation2d setValue(double x, double y) {
    double magnitude = Math.hypot(x, y);
    if (magnitude > 1e-6) {
      m_cos = x / magnitude;
      m_sin = y / magnitude;
  ...
  /**
   * Constructs a NzRotation2d with the given angle.
   *
  ...
  /**
   * Constructs a NzRotation2d from a rotation matrix.
   *
  ...
  /**
   * Constructs and returns a NzRotation2d with the given radian value.
   *
  ...
  /**
   * Constructs and returns a NzRotation2d with the given degree value.
   *
  ...
  /**
   * Constructs and returns a NzRotation2d with the given number of rotations.
   *
   ...
   *
   * <p>For example, <code>NzRotation2d.fromDegrees(30).plus(NzRotation2d.fromDegrees(60))</code> equals
   * <code>NzRotation2d(Math.PI/2.0)</code>
   *
   ...
   *
   * <p>For example, <code>NzRotation2d.fromDegrees(10).minus(NzRotation2d.fromDegrees(100))</code>
   * equals <code>NzRotation2d(-Math.PI/2.0)</code>
   *
  ...
  public Rotation2d unaryMinus() {
    // Old implementation:
    // return new NzRotation2d(-m_value);
   ...
   * @return The new scaled NzRotation2d.
   */
  public Rotation2d times(double scalar) {
    // Old implementation;
    // return new NzRotation2d(m_value * scalar);
    return setValue(m_value * scalar);
  }
   ...
   * @return The new rotated NzRotation2d.
   */
  ...
  /**
   * Returns the measure of the NzRotation2d.
   *
   * @return The measure of the NzRotation2d.
   */
  ...
  /**
   * Returns the radian value of the NzRotation2d.
   *
   * @return The radian value of the NzRotation2d.
  ...
  /**
   * Returns the degree value of the NzRotation2d.
   *
   * @return The degree value of the NzRotation2d.
  ...
  /**
   * Returns the number of rotations of the NzRotation2d.
   *
   * @return The number of rotations of the NzRotation2d.
   */
  ...
  /**
   * Returns the cosine of the NzRotation2d.
   *
   * @return The cosine of the NzRotation2d.
   */
  ...
  /**
   * Returns the sine of the NzRotation2d.
   *
   * @return The sine of the NzRotation2d.
   */
  ...
  /**
   * Returns the tangent of the NzRotation2d.
   *
   * @return The tangent of the NzRotation2d.
   */
  ...
  public String toString() {
    return String.format("NzRotation2d(Rads: %.2f, Deg: %.2f)", m_value, Math.toDegrees(m_value));
  }

  /**
   * Checks equality between this NzRotation2d and another object.
   *
